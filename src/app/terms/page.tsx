          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            ...
            <div className="prose prose-gray max-w-none">
              <section className="mb-8">
                ...
                <p className="text-gray-600 mb-4">{t.terms.section1.content}</p>
              </section>

              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t.terms.section2.title}</h2>
                <p className="text-gray-600 mb-4">{t.terms.section2.content}</p>
                <ul className="list-disc list-inside text-gray-600 space-y-2">
                  {t.terms.section2.items.map((item: string, index: number) => (
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 mb-4">{t.terms.section3.content}</p>
              </section>

              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t.terms.section4.title}</h2>
                <p className="text-gray-600 mb-4">{t.terms.section4.content}</p>
              </section>

              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t.terms.section5.title}</h2>
                <p className="text-gray-600 mb-4">{t.terms.section5.content}</p>
              </section>

              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t.terms.section6.title}</h2>
                <p className="text-gray-600 mb-4">{t.terms.section6.content}</p>
              </section>

              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">{t.terms.section7.title}</h2>
                <p className="text-gray-600 mb-4">{t.terms.section7.content}</p>
                <p className="text-gray-600 mt-4">
                  <strong>{t.terms.section7.email}:</strong>{' '}
                  <a href="mailto:legal@propertyfinder.com" className="text-blue-600 hover:underline">
                    legal@propertyfinder.com
                  </a>
                </p>
              </section>
            </div>
